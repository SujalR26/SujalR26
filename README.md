...
- [**EcoSnap**](https://github.com/SujalR26/HackByte): AI-powered civic hazard reporting platform using FastAPI, Supabase, Google Cloud Vision, and Gemini AI for hazard detection, reporting, and analytics.
- [**Talkify**](https://talkify-gi51.onrender.com/): Real-time MERN chat application with Socket.io, authentication, and a responsive DaisyUI-powered interface.
...
* ⭐ **3★** on CodeChef
* 📈 **Pupil** on Codeforces
* 🚀 Continuously improving in Data Structures, Algorithms, and Competitive Programming.
...
![Google Cloud Vision](https://img.shields.io/badge/Google_Cloud_Vision-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white)
...
![Profile views](https://komarev.com/ghpvc/?username=SujalR26&style=for-the-badge&color=0e75b6)
# 📊 GitHub Stats
